...
export const CHORD_LIBRARY: Chord[] = [
  ...
  // === Minor-Major 7ths (m(maj7)) — 6 missing roots ===
  { id: 'c-sharp-minmaj7', name: 'C# Minor Major 7', shortName: 'C#m(maj7)', root: 'C#', type: 'extended', difficulty: 'intermediate', theory: { intervals: ['R', 'm3', 'P5', 'M7'], construction: 'Minor Triad + Major 7th', commonProgressions: ['i(maj7)'] }, voicings: [{ voicingName: 'Root Position', position: 1, guitar: { frets: [-1, 4, 6, 5, 5, 4], fingers: ['muted', '1', '4', '2', '3', '1'], muted: [1], barred: true, description: 'A-shape barre at 4th fret.' }, piano: { notes: ['C#4', 'E4', 'G#4', 'B#4'], octaveRange: [4, 4], description: 'Root position.' } }], description: 'Minor-major 7.', tags: ['intermediate', 'extended', 'minmaj7'] },
  { id: 'eb-minmaj7', name: 'Eb Minor Major 7', shortName: 'Ebm(maj7)', root: 'Eb', type: 'extended', difficulty: 'intermediate', theory: { intervals: ['R', 'm3', 'P5', 'M7'], construction: 'Minor Triad + Major 7th', commonProgressions: ['i(maj7)'] }, voicings: [{ voicingName: 'Root Position', position: 1, guitar: { frets: [-1, 6, 8, 7, 7, 6], fingers: ['muted', '1', '4', '2', '3', '1'], muted: [1], barred: true, description: 'A-shape barre at 6th fret.' }, piano: { notes: ['Eb4', 'Gb4', 'Bb4', 'D5'], octaveRange: [4, 5], description: 'Root position.' } }], description: 'Minor-major 7.', tags: ['intermediate', 'extended', 'minmaj7'] },
  { id: 'f-sharp-minmaj7', name: 'F# Minor Major 7', shortName: 'F#m(maj7)', root: 'F#', type: 'extended', difficulty: 'intermediate', theory: { intervals: ['R', 'm3', 'P5', 'M7'], construction: 'Minor Triad + Major 7th', commonProgressions: ['i(maj7)'] }, voicings: [{ voicingName: 'Root Position', position: 1, guitar: { frets: [2, 4, 3, 2, 2, 2], fingers: ['1', '4', '2', '1', '1', '1'], muted: [], barred: true, description: 'E-shape barre at 2nd fret.' }, piano: { notes: ['F#4', 'A4', 'C#5', 'E#5'], octaveRange: [4, 5], description: 'Root position.' } }], description: 'Minor-major 7.', tags: ['intermediate', 'extended', 'minmaj7'] },
  { id: 'g-minmaj7', name: 'G Minor Major 7', shortName: 'Gm(maj7)', root: 'G', type: 'extended', difficulty: 'intermediate', theory: { intervals: ['R', 'm3', 'P5', 'M7'], construction: 'Minor Triad + Major 7th', commonProgressions: ['i(maj7)'] }, voicings: [{ voicingName: 'Root Position', position: 1, guitar: { frets: [3, 5, 4, 3, 3, 3], fingers: ['1', '4', '2', '1', '1', '1'], muted: [], barred: true, description: 'E-shape barre at 3rd fret.' }, piano: { notes: ['G4', 'Bb4', 'D5', 'F#5'], octaveRange: [4, 5], description: 'Root position.' } }], description: 'Minor-major 7.', tags: ['intermediate', 'extended', 'minmaj7'] },
  { id: 'ab-minmaj7', name: 'Ab Minor Major 7', shortName: 'Abm(maj7)', root: 'Ab', type: 'extended', difficulty: 'intermediate', theory: { intervals: ['R', 'm3', 'P5', 'M7'], construction: 'Minor Triad + Major 7th', commonProgressions: ['i(maj7)'] }, voicings: [{ voicingName: 'Root Position', position: 1, guitar: { frets: [4, 6, 5, 4, 4, 4], fingers: ['1', '4', '2', '1', '1', '1'], muted: [], barred: true, description: 'E-shape barre at 4th fret.' }, piano: { notes: ['Ab3', 'Cb4', 'Eb4', 'G4'], octaveRange: [3, 4], description: 'Root position.' } }], description: 'Minor-major 7.', tags: ['intermediate', 'extended', 'minmaj7'] },
  { id: 'bb-minmaj7', name: 'Bb Minor Major 7', shortName: 'Bbm(maj7)', root: 'Bb', type: 'extended', difficulty: 'intermediate', theory: { intervals: ['R', 'm3', 'P5', 'M7'], construction: 'Minor Triad + Major 7th', commonProgressions: ['i(maj7)'] }, voicings: [{ voicingName: 'Root Position', position: 1, guitar: { frets: [-1, 1, 3, 2, 2, 1], fingers: ['muted', '1', '4', '3', '2', '1'], muted: [1], barred: true, description: 'A-shape barre at 1st fret.' }, piano: { notes: ['Bb3', 'Db4', 'F4', 'A4'], octaveRange: [3, 4], description: 'Root position.' } }], description: 'Minor-major 7.', tags: ['intermediate', 'extended', 'minmaj7'] },
  // === Augmented Major 7ths (aug(maj7)) — all 12 roots ===
  { id: 'c-augmaj7', name: 'C Augmented Major 7', shortName: 'Caug(maj7)', root: 'C', type: 'augmented', difficulty: 'advanced', theory: { intervals: ['R', 'M3', 'A5', 'M7'], construction: 'Augmented Triad + Major 7th', commonProgressions: ['Imaj7#5'] }, voicings: [{ voicingName: 'Root Position', position: 1, guitar: { frets: [-1, 3, 2, 1, 0, 0], fingers: ['muted', '3', '2', '1', 'open', 'open'], muted: [1], barred: false, description: 'Open voicing.' }, piano: { notes: ['C4', 'E4', 'G#4', 'B4'], octaveRange: [4, 4], description: 'Root position.' } }], description: 'Augmented major 7.', tags: ['advanced', 'augmented', 'augmaj7'] },
  { id: 'c-sharp-augmaj7', name: 'C# Augmented Major 7', shortName: 'C#aug(maj7)', root: 'C#', type: 'augmented', difficulty: 'advanced', theory: { intervals: ['R', 'M3', 'A5', 'M7'], construction: 'Augmented Triad + Major 7th', commonProgressions: ['Imaj7#5'] }, voicings: [{ voicingName: 'Root Position', position: 1, guitar: { frets: [-1, 4, 3, 2, 1, -1], fingers: ['muted', '4', '3', '2', '1', 'muted'], muted: [1, 6], barred: false, description: 'Moveable shape.' }, piano: { notes: ['C#4', 'E#4', 'G##4', 'B#4'], octaveRange: [4, 4], description: 'Root position.' } }], description: 'Augmented major 7.', tags: ['advanced', 'augmented', 'augmaj7'] },
  { id: 'd-augmaj7', name: 'D Augmented Major 7', shortName: 'Daug(maj7)', root: 'D', type: 'augmented', difficulty: 'advanced', theory: { intervals: ['R', 'M3', 'A5', 'M7'], construction: 'Augmented Triad + Major 7th', commonProgressions: ['Imaj7#5'] }, voicings: [{ voicingName: 'Root Position', position: 1, guitar: { frets: [-1, 5, 4, 3, 2, -1], fingers: ['muted', '4', '3', '2', '1', 'muted'], muted: [1, 6], barred: false, description: 'Moveable shape.' }, piano: { notes: ['D4', 'F#4', 'A#4', 'C#5'], octaveRange: [4, 5], description: 'Root position.' } }], description: 'Augmented major 7.', tags: ['advanced', 'augmented', 'augmaj7'] },
  { id: 'eb-augmaj7', name: 'Eb Augmented Major 7', shortName: 'Ebaug(maj7)', root: 'Eb', type: 'augmented', difficulty: 'advanced', theory: { intervals: ['R', 'M3', 'A5', 'M7'], construction: 'Augmented Triad + Major 7th', commonProgressions: ['Imaj7#5'] }, voicings: [{ voicingName: 'Root Position', position: 1, guitar: { frets: [-1, 6, 5, 4, 3, -1], fingers: ['muted', '4', '3', '2', '1', 'muted'], muted: [1, 6], barred: false, description: 'Moveable shape.' }, piano: { notes: ['Eb4', 'G4', 'B4', 'D5'], octaveRange: [4, 5], description: 'Root position.' } }], description: 'Augmented major 7.', tags: ['advanced', 'augmented', 'augmaj7'] },
  { id: 'e-augmaj7', name: 'E Augmented Major 7', shortName: 'Eaug(maj7)', root: 'E', type: 'augmented', difficulty: 'advanced', theory: { intervals: ['R', 'M3', 'A5', 'M7'], construction: 'Augmented Triad + Major 7th', commonProgressions: ['Imaj7#5'] }, voicings: [{ voicingName: 'Root Position', position: 1, guitar: { frets: [0, -1, 1, 1, 1, -1], fingers: ['open', 'muted', '1', '2', '3', 'muted'], muted: [2, 6], barred: false, description: 'Open E root voicing.' }, piano: { notes: ['E4', 'G#4', 'B#4', 'D#5'], octaveRange: [4, 5], description: 'Root position.' } }], description: 'Augmented major 7.', tags: ['advanced', 'augmented', 'augmaj7'] },
  { id: 'f-augmaj7', name: 'F Augmented Major 7', shortName: 'Faug(maj7)', root: 'F', type: 'augmented', difficulty: 'advanced', theory: { intervals: ['R', 'M3', 'A5', 'M7'], construction: 'Augmented Triad + Major 7th', commonProgressions: ['Imaj7#5'] }, voicings: [{ voicingName: 'Root Position', position: 1, guitar: { frets: [1, 0, 3, 2, 2, 0], fingers: ['2', 'open', '4', '3', '3', 'open'], muted: [], barred: false, description: 'F root voicing.' }, piano: { notes: ['F4', 'A4', 'C#5', 'E5'], octaveRange: [4, 5], description: 'Root position.' } }], description: 'Augmented major 7.', tags: ['advanced', 'augmented', 'augmaj7'] },
  { id: 'f-sharp-augmaj7', name: 'F# Augmented Major 7', shortName: 'F#aug(maj7)', root: 'F#', type: 'augmented', difficulty: 'advanced', theory: { intervals: ['R', 'M3', 'A5', 'M7'], construction: 'Augmented Triad + Major 7th', commonProgressions: ['Imaj7#5'] }, voicings: [{ voicingName: 'Root Position', position: 1, guitar: { frets: [-1, -1, 4, 3, 3, 1], fingers: ['muted', 'muted', '4', '2', '3', '1'], muted: [1, 2], barred: false, description: 'Compact voicing.' }, piano: { notes: ['F#4', 'A#4', 'C##5', 'E#5'], octaveRange: [4, 5], description: 'Root position.' } }], description: 'Augmented major 7.', tags: ['advanced', 'augmented', 'augmaj7'] },
  { id: 'g-augmaj7', name: 'G Augmented Major 7', shortName: 'Gaug(maj7)', root: 'G', type: 'augmented', difficulty: 'advanced', theory: { intervals: ['R', 'M3', 'A5', 'M7'], construction: 'Augmented Triad + Major 7th', commonProgressions: ['Imaj7#5'] }, voicings: [{ voicingName: 'Root Position', position: 1, guitar: { frets: [3, -1, 4, 4, 4, 3], fingers: ['1', 'muted', '2', '3', '4', '1'], muted: [2], barred: true, description: 'G root voicing.' }, piano: { notes: ['G4', 'B4', 'D#5', 'F#5'], octaveRange: [4, 5], description: 'Root position.' } }], description: 'Augmented major 7.', tags: ['advanced', 'augmented', 'augmaj7'] },
  { id: 'ab-augmaj7', name: 'Ab Augmented Major 7', shortName: 'Abaug(maj7)', root: 'Ab', type: 'augmented', difficulty: 'advanced', theory: { intervals: ['R', 'M3', 'A5', 'M7'], construction: 'Augmented Triad + Major 7th', commonProgressions: ['Imaj7#5'] }, voicings: [{ voicingName: 'Root Position', position: 1, guitar: { frets: [4, -1, 5, 5, 5, 4], fingers: ['1', 'muted', '2', '3', '4', '1'], muted: [2], barred: true, description: 'Ab root voicing.' }, piano: { notes: ['Ab3', 'C4', 'E4', 'G4'], octaveRange: [3, 4], description: 'Root position.' } }], description: 'Augmented major 7.', tags: ['advanced', 'augmented', 'augmaj7'] },
  { id: 'a-augmaj7', name: 'A Augmented Major 7', shortName: 'Aaug(maj7)', root: 'A', type: 'augmented', difficulty: 'advanced', theory: { intervals: ['R', 'M3', 'A5', 'M7'], construction: 'Augmented Triad + Major 7th', commonProgressions: ['Imaj7#5'] }, voicings: [{ voicingName: 'Root Position', position: 1, guitar: { frets: [-1, 0, 3, 1, 2, 1], fingers: ['muted', 'open', '4', '1', '3', '2'], muted: [1], barred: false, description: 'Open A root voicing.' }, piano: { notes: ['A3', 'C#4', 'E#4', 'G#4'], octaveRange: [3, 4], description: 'Root position.' } }], description: 'Augmented major 7.', tags: ['advanced', 'augmented', 'augmaj7'] },
  { id: 'bb-augmaj7', name: 'Bb Augmented Major 7', shortName: 'Bbaug(maj7)', root: 'Bb', type: 'augmented', difficulty: 'advanced', theory: { intervals: ['R', 'M3', 'A5', 'M7'], construction: 'Augmented Triad + Major 7th', commonProgressions: ['Imaj7#5'] }, voicings: [{ voicingName: 'Root Position', position: 1, guitar: { frets: [-1, 1, 4, 2, 3, 2], fingers: ['muted', '1', '4', '2', '3', '2'], muted: [1], barred: false, description: 'Bb root voicing.' }, piano: { notes: ['Bb3', 'D4', 'F#4', 'A4'], octaveRange: [3, 4], description: 'Root position.' } }], description: 'Augmented major 7.', tags: ['advanced', 'augmented', 'augmaj7'] },
  { id: 'b-augmaj7', name: 'B Augmented Major 7', shortName: 'Baug(maj7)', root: 'B', type: 'augmented', difficulty: 'advanced', theory: { intervals: ['R', 'M3', 'A5', 'M7'], construction: 'Augmented Triad + Major 7th', commonProgressions: ['Imaj7#5'] }, voicings: [{ voicingName: 'Root Position', position: 1, guitar: { frets: [3, 2, 1, 3, -1, -1], fingers: ['2', '1', '1', '3', 'muted', 'muted'], muted: [5, 6], barred: true, description: 'Compact B root voicing.' }, piano: { notes: ['B3', 'D#4', 'F##4', 'A#4'], octaveRange: [3, 4], description: 'Root position.' } }], description: 'Augmented major 7.', tags: ['advanced', 'augmented', 'augmaj7'] },
  // === Diminished 7ths (dim7) — 10 missing roots ===
  { id: 'eb-dim7', name: 'Eb Diminished 7', shortName: 'Ebdim7', root: 'Eb', type: 'diminished', difficulty: 'advanced', theory: { intervals: ['R', 'm3', 'd5', 'dd7'], construction: 'Diminished Triad + Diminished 7th', commonProgressions: ['viio7'] }, voicings: [{ voicingName: 'Root Position', position: 1, guitar: { frets: [-1, -1, 1, 2, 1, 2], fingers: ['muted', 'muted', '1', '3', '1', '4'], muted: [1, 2], barred: true, description: 'Compact dim7 voicing.' }, piano: { notes: ['Eb4', 'Gb4', 'Bbb4', 'Dbb5'], octaveRange: [4, 5], description: 'Root position.' } }], description: 'Diminished 7.', tags: ['advanced', 'diminished', 'dim7'] },
  ...
  { id: 'bb-dim7', name: 'Bb Diminished 7', shortName: 'Bbdim7', root: 'Bb', type: 'diminished', difficulty: 'advanced', theory: { intervals: ['R', 'm3', 'd5', 'dd7'], construction: 'Diminished Triad + Diminished 7th', commonProgressions: ['viio7'] }, voicings: [{ voicingName: 'Root Position', position: 1, guitar: { frets: [-1, 1, 2, 3, 2, 3], fingers: ['muted', '1', '2', '3', '2', '4'], muted: [1], barred: false, description: 'A-string root dim7.' }, piano: { notes: ['Bb3', 'Db4', 'Fb4', 'Abb4'], octaveRange: [3, 4], description: 'Root position.' } }], description: 'Diminished 7.', tags: ['advanced', 'diminished', 'dim7'] },
  { id: 'b-dim7', name: 'B Diminished 7', shortName: 'Bdim7', root: 'B', type: 'diminished', difficulty: 'advanced', theory: { intervals: ['R', 'm3', 'd5', 'dd7'], construction: 'Diminished Triad + Diminished 7th', commonProgressions: ['viio7'] }, voicings: [{ voicingName: 'Root Position', position: 1, guitar: { frets: [-1, 2, 3, 1, 3, 1], fingers: ['muted', '2', '3', '1', '4', '1'], muted: [1], barred: true, description: 'A-string root dim7.' }, piano: { notes: ['B3', 'D4', 'F4', 'Ab4'], octaveRange: [3, 4], description: 'Root position.' } }], description: 'Diminished 7.', tags: ['advanced', 'diminished', 'dim7'] },
  { id: 'c-sharp-dim7', name: 'C# Diminished 7', shortName: 'C#dim7', root: 'C#', type: 'diminished', difficulty: 'advanced', theory: { intervals: ['R', 'm3', 'd5', 'dd7'], construction: 'Diminished Triad + Diminished 7th', commonProgressions: ['viio7'] }, voicings: [{ voicingName: 'Root Position', position: 1, guitar: { frets: [-1, 4, 5, 3, 5, 3], fingers: ['muted', '2', '3', '1', '4', '1'], muted: [1], barred: true, description: 'A-string root dim7.' }, piano: { notes: ['C#4', 'E4', 'G4', 'Bb4'], octaveRange: [4, 4], description: 'Root position.' } }], description: 'Diminished 7.', tags: ['advanced', 'diminished', 'dim7'] },
