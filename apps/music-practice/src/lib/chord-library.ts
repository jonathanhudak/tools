...
export const CHORD_LIBRARY: Chord[] = [
  ...
  { id: 'dm7-g7-cmaj7-1', name: 'Dm7 (ii)', shortName: 'Dm7', root: 'D', type: 'extended', difficulty: 'jazz', theory: { intervals: ['R', 'm3', 'P5', 'm7'], construction: 'Minor 7', commonProgressions: ['ii-V-I'] }, voicings: [{ voicingName: 'Shell Voicing', position: 1, guitar: { frets: [-1, 0, 0, 2, 1, 0], fingers: ['muted', 'open', 'open', '2', '1', 'open'], muted: [1], barred: false, description: 'Jazz shell.' }, piano: { notes: ['D4', 'F4', 'A4', 'C5'], octaveRange: [4, 5], description: 'ii voicing.' } }], description: 'Jazz ii chord in ii-V-I progression.', tags: ['jazz', 'ii-V-I', 'extended'] },
  { id: 'g7-jazz-v', name: 'G7 (V)', shortName: 'G7', root: 'G', type: 'dominant', difficulty: 'jazz', theory: { intervals: ['R', 'M3', 'P5', 'm7'], construction: 'Dominant 7', commonProgressions: ['ii-V-I'] }, voicings: [{ voicingName: 'Jazz Shell', position: 1, guitar: { frets: [3, 2, 0, 0, 0, 2], fingers: ['3', '2', 'open', 'open', 'open', '2'], muted: [], barred: false, description: 'Jazz V shell.' }, piano: { notes: ['G3', 'B3', 'F4'], octaveRange: [3, 4], description: 'V shell (R-3-b7).' } }], description: 'Jazz V chord in ii-V-I.', tags: ['jazz', 'ii-V-I', 'dominant'] },
  ...
  { id: 'c7-blues-i', name: 'C7 (Blues I)', shortName: 'C7', root: 'C', type: 'dominant', difficulty: 'jazz', theory: { intervals: ['R', 'M3', 'P5', 'm7'], construction: 'Dominant 7', commonProgressions: ['blues'] }, voicings: [{ voicingName: 'Blues Shell', position: 1, guitar: { frets: [0, 3, 2, 3, 0, 0], fingers: ['open', '3', '2', '3', 'open', 'open'], muted: [], barred: false, description: 'Blues voicing.' }, piano: { notes: ['C4', 'E4', 'Bb4'], octaveRange: [4, 4], description: 'Blues I7 shell.' } }], description: 'Blues I7 chord.', tags: ['jazz', 'blues', 'dominant'] },
  { id: 'f7-blues-iv', name: 'F7 (Blues IV)', shortName: 'F7', root: 'F', type: 'dominant', difficulty: 'jazz', theory: { intervals: ['R', 'M3', 'P5', 'm7'], construction: 'Dominant 7', commonProgressions: ['blues'] }, voicings: [{ voicingName: 'Blues Shell', position: 1, guitar: { frets: [1, 3, 2, 2, 1, 1], fingers: ['1', '3', '2', '2', '1', '1'], muted: [], barred: false, description: 'Blues voicing.' }, piano: { notes: ['F4', 'A4', 'Eb5'], octaveRange: [4, 5], description: 'Blues IV7 shell.' } }], description: 'Blues IV7 chord.', tags: ['jazz', 'blues', 'dominant'] },
  { id: 'g7-blues-v', name: 'G7 (Blues V)', shortName: 'G7', root: 'G', type: 'dominant', difficulty: 'jazz', theory: { intervals: ['R', 'M3', 'P5', 'm7'], construction: 'Dominant 7', commonProgressions: ['blues'] }, voicings: [{ voicingName: 'Blues Shell', position: 1, guitar: { frets: [3, 2, 0, 0, 0, 3], fingers: ['3', '2', 'open', 'open', 'open', '3'], muted: [], barred: false, description: 'Blues voicing.' }, piano: { notes: ['G3', 'B3', 'F4'], octaveRange: [3, 4], description: 'Blues V7 shell.' } }], description: 'Blues V7 chord.', tags: ['jazz', 'blues', 'dominant'] },

  // Jazz Standards (Autumn Leaves, Giant Steps, etc.) - 16 chords
  { id: 'bm7b5-autumn', name: 'Bm7b5 (Autumn Leaves)', shortName: 'Bm7b5', root: 'B', type: 'extended', difficulty: 'jazz', theory: { intervals: ['R', 'm3', 'd5', 'm7'], construction: 'Half-diminished', commonProgressions: ['autumn-leaves'] }, voicings: [{ voicingName: 'Shell Voicing', position: 1, guitar: { frets: [2, 2, 3, 2, 2, 0], fingers: ['1', '1', '2', '1', '1', 'open'], muted: [], barred: false, description: 'Autumn voicing.' }, piano: { notes: ['B3', 'D4', 'F4', 'A4'], octaveRange: [3, 4], description: 'Half-dim shell.' } }], description: 'Autumn Leaves ii chord.', tags: ['jazz', 'standards', 'autumn-leaves'] },
  ...
  { id: 'd-dorian', name: 'D Dorian', shortName: 'Dm7', root: 'D', type: 'extended', difficulty: 'jazz', theory: { intervals: ['R', 'm3', 'P5', 'm7'], construction: 'Minor 7 (Dorian mode)', commonProgressions: ['modal'] }, voicings: [{ voicingName: 'Modal Voicing', position: 1, guitar: { frets: [-1, 0, 0, 2, 1, 0], fingers: ['muted', 'open', 'open', '2', '1', 'open'], muted: [1], barred: false, description: 'Dorian.' }, piano: { notes: ['D4', 'F4', 'A4', 'C5'], octaveRange: [4, 5], description: 'Dorian voicing.' } }], description: 'Modal jazz - Dorian.', tags: ['jazz', 'modal', 'dorian'] },
  ...
  { id: 'c-lydian', name: 'C Lydian', shortName: 'Cmaj7', root: 'C', type: 'extended', difficulty: 'jazz', theory: { intervals: ['R', 'M3', '#P4', 'M7'], construction: 'Major 7 (Lydian mode)', commonProgressions: ['modal'] }, voicings: [{ voicingName: 'Modal Voicing', position: 1, guitar: { frets: [0, 3, 2, 0, 0, 0], fingers: ['open', '3', '2', 'open', 'open', 'open'], muted: [], barred: false, description: 'Lydian.' }, piano: { notes: ['C4', 'E4', 'F#4', 'B4'], octaveRange: [4, 4], description: 'Lydian voicing.' } }], description: 'Modal jazz - Lydian.', tags: ['jazz', 'modal', 'lydian'] },

  // Upper structure triads (jazz voicings) - 12 chords
  { id: 'cmaj7-upper-em', name: 'Cmaj7 (Em upper structure)', shortName: 'Cmaj7', root: 'C', type: 'extended', difficulty: 'jazz', theory: { intervals: ['R', 'M3', 'P5', 'M7'], construction: 'Em triad over C', commonProgressions: ['upper-structure'] }, voicings: [{ voicingName: 'Upper Structure', position: 1, guitar: { frets: [0, 3, 0, 0, 0, 0], fingers: ['open', '3', 'open', 'open', 'open', 'open'], muted: [], barred: false, description: 'Upper structure.' }, piano: { notes: ['C4', 'E4', 'G4', 'B4'], octaveRange: [4, 4], description: 'Em over C.' } }], description: 'Upper structure triad.', tags: ['jazz', 'upper-structure'] },
  { id: 'gmaj7-upper-bm', name: 'Gmaj7 (Bm upper structure)', shortName: 'Gmaj7', root: 'G', type: 'extended', difficulty: 'jazz', theory: { intervals: ['R', 'M3', 'P5', 'M7'], construction: 'Bm triad over G', commonProgressions: ['upper-structure'] }, voicings: [{ voicingName: 'Upper Structure', position: 1, guitar: { frets: [3, 2, 0, 0, 0, 0], fingers: ['3', '2', 'open', 'open', 'open', 'open'], muted: [], barred: false, description: 'Upper structure.' }, piano: { notes: ['G3', 'B3', 'D4', 'F#4'], octaveRange: [3, 4], description: 'Bm over G.' } }], description: 'Upper structure triad.', tags: ['jazz', 'upper-structure'] },
  ...
  { id: 'gmaj7b5', name: 'Gmaj7 b5', shortName: 'Gmaj7b5', root: 'G', type: 'extended', difficulty: 'jazz', theory: { intervals: ['R', 'M3', 'd5', 'M7'], construction: 'Major 7 with flat 5', commonProgressions: ['jazz-progressions'] }, voicings: [{ voicingName: 'Root Position', position: 1, guitar: { frets: [3, 2, 0, 0, 0, 0], fingers: ['3', '2', 'open', 'open', 'open', 'open'], muted: [], barred: false, description: 'Jazz maj7b5.' }, piano: { notes: ['G3', 'B3', 'Db4', 'F#4'], octaveRange: [3, 4], description: 'Maj7b5.' } }], description: 'Jazz maj7 b5.', tags: ['jazz', 'extended'] },
];
