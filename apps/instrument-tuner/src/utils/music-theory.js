 ...
 */
export function midiToVexflow(midiNote, clef = 'treble') {
 ...
 */
export function generateRandomNote(range = 'c4-c5', clef = 'treble', naturalsOnly = true) {
 ...
 */
export function generateRandomNoteFromMidiRange(minMidi, maxMidi, naturalsOnly = true) {
 ...
 */
export function validateNote(playedMidi, targetMidi, options = {}) {
    const { allowOctaveError = true, tolerance = 0, pitchToleranceCents = 0 } = options;
 ...
 */
export function validatePitchWithCents(playedFrequency, targetMidi, toleranceCents = 50) {
 ...
 */
export function getCentsFromMidi(frequency, targetMidi) {
    const targetFrequency = midiToFrequency(targetMidi);
 ...
 */
export function generateMinorScale(root) {
 ...
 */
export function generateScale(root, scaleType = 'major') {
 ...
 */
export function generateChord(root, type = 'major') {
 ...
 */
export function isFrequencyInRange(frequency, minFreq, maxFreq) {
