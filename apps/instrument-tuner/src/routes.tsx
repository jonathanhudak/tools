...
// Import the TunerPage component from routes/index.tsx
// We need to import it dynamically since it uses createFileRoute
...
function TunerPage() {
  ...
  const handlePitchDetectedRef = useRef<(event: PitchDetectedEvent) => void>(() => {});
